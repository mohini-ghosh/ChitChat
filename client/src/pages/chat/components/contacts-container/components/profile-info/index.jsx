...
//   // Determine which image to show: selected contact first, else current user
//   const displayName = selectedChat
//     ? `${selectedChat.firstname || ""} ${selectedChat.lastname || ""}`
//     : `${userInfo.firstname || ""} ${userInfo.lastname || ""}`;
//   const displayImage = selectedChat?.image
//     ? selectedChat.image
//     : userInfo.image
//     ? `${baseURL}${userInfo.image}`
//     : null;
//   const displayColor = userInfo.selectedcolor || 0;
...
//               />
//             ) : (
//               <AvatarFallback className={`uppercase w-12 h-12 text-lg border flex items-center justify-center text-white rounded-full ${getColor(displayColor)}`}>
...
//           <Tooltip>
//             <TooltipTrigger asChild>
//               <FiEdit2 onClick={() => navigate('/profile')} className="text-purple-500 text-xl cursor-pointer" />
//             </TooltipTrigger>
//             <TooltipContent className="bg-[#1c1b1e] border-none text-white">
//               <p>Edit Profile</p>
//             </TooltipContent>
...
//           <Tooltip>
//             <TooltipTrigger asChild>
//               <IoPowerSharp onClick={logOut} className="text-red-500 text-xl cursor-pointer" />
//             </TooltipTrigger>
//             <TooltipContent className="bg-[#1c1b1e] border-none text-white">
//               <p>Logout</p>
//             </TooltipContent>
